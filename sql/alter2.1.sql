...
CREATE TABLE `0_recurrent_invoices` (
  ...
  `consignor_no` int(11) UNSIGNED NULL default NULL,
...
ALTER TABLE `0_consignor_branch` ADD `group_no` int(11) NOT NULL default '0';

ALTER TABLE `0_consignor_trans` ADD `dimension_id` int(11) NOT NULL default '0';
ALTER TABLE `0_consignor_trans` ADD `dimension2_id` int(11) NOT NULL default '0';
...
INSERT INTO `0_transport_pos` VALUES ('1', 'Default', '0', '1', 'DEF', '1', '0');
...
INSERT INTO `0_quick_entries` VALUES ('3', '2', 'Cash Transport', '0', 'Amount');
...
INSERT INTO `0_print_profiles` VALUES ('2', 'Transport Department', '', '0');
INSERT INTO `0_print_profiles` VALUES ('3', 'Central', '', '2');
INSERT INTO `0_print_profiles` VALUES ('4', 'Transport Department', '104', '2');
INSERT INTO `0_print_profiles` VALUES ('5', 'Transport Department', '105', '2');
INSERT INTO `0_print_profiles` VALUES ('6', 'Transport Department', '107', '2');
INSERT INTO `0_print_profiles` VALUES ('7', 'Transport Department', '109', '2');
INSERT INTO `0_print_profiles` VALUES ('8', 'Transport Department', '110', '2');
INSERT INTO `0_print_profiles` VALUES ('9', 'Transport Department', '201', '2');
...
ALTER TABLE `0_consignors_master` ADD `inactive` tinyint(1) NOT NULL DEFAULT '0';
...
ALTER TABLE `0_transport_types` ADD `inactive` tinyint(1) NOT NULL DEFAULT '0';

ALTER TABLE `0_areas` ADD `inactive` tinyint(1) NOT NULL DEFAULT '0';

ALTER TABLE `0_transportman` ADD `inactive` tinyint(1) NOT NULL DEFAULT '0';
