...
ALTER TABLE 0_consignor_branch DROP KEY `br_name`, ADD KEY (`branch_ref`), ADD KEY (`group_no`);
ALTER TABLE 0_consignors_master ADD KEY (`consignor_ref`);
ALTER TABLE 0_consignor_trans DROP PRIMARY KEY, ADD PRIMARY KEY (`type`, `trans_no`), ADD KEY (`tran_date`);
ALTER TABLE 0_consignor_trans_details ADD KEY `Transaction` (`consignor_trans_type`, `consignor_trans_no`);
ALTER TABLE 0_consignor_allocations ADD KEY `From` (`trans_type_from`, `trans_no_from`), ADD KEY `To` (`trans_type_to`, `trans_no_to`);
ALTER TABLE 0_transport_order_details ADD KEY `sorder` (`trans_type`, `order_no`);
...
INSERT INTO `0_sys_prefs` SELECT 'no_consignor_list','setup.company', 'tinyint','1', c.no_consignor_list FROM `0_company` c;
INSERT INTO `0_sys_prefs` SELECT 'no_supplier_list','setup.company', 'tinyint','1', c.no_supplier_list FROM `0_company` c;
INSERT INTO `0_sys_prefs` SELECT 'base_transport','setup.company', 'int','11', c.base_transport FROM `0_company` c;
...
INSERT INTO `0_sys_prefs` SELECT 'default_credit_limit','glsetup.consignor', 'int','11', c.default_credit_limit FROM `0_company` c;
INSERT INTO `0_sys_prefs` SELECT 'accumulate_shipping','glsetup.consignor', 'tinyint','1', c.accumulate_shipping FROM `0_company` c;
INSERT INTO `0_sys_prefs` SELECT 'legal_text','glsetup.consignor', 'tinytext','0', c.legal_text FROM `0_company` c;
INSERT INTO `0_sys_prefs` SELECT 'freight_act','glsetup.consignor', 'varchar','15', c.freight_act FROM `0_company` c;

INSERT INTO `0_sys_prefs` SELECT 'consignors_act','glsetup.transport', 'varchar','15', c.consignors_act FROM `0_company` c;
INSERT INTO `0_sys_prefs` SELECT 'default_transport_act','glsetup.transport', 'varchar','15', c.default_transport_act FROM `0_company` c;
INSERT INTO `0_sys_prefs` SELECT 'default_transport_discount_act','glsetup.transport', 'varchar','15', c.default_transport_discount_act FROM `0_company` c;
INSERT INTO `0_sys_prefs` SELECT 'default_prompt_payment_act','glsetup.transport', 'varchar','15', c.default_prompt_payment_act FROM `0_company` c;
INSERT INTO `0_sys_prefs` SELECT 'default_delivery_required','glsetup.transport', 'smallint','6', c.default_delivery_required FROM `0_company` c;
...
INSERT INTO `0_sys_prefs` SELECT 'default_inv_transport_act','glsetup.items', 'varchar','15', c.default_inv_transport_act FROM `0_company` c;
...
ALTER TABLE `0_consignor_trans` ADD COLUMN `payment_terms` int(11) default NULL;
ALTER TABLE `0_transport_orders` ADD COLUMN `payment_terms` int(11) default NULL;
ALTER TABLE `0_transport_orders` ADD COLUMN `total` double NOT NULL default '0';
...
ALTER TABLE `0_consignor_branch` CHANGE `transport_account` `transport_account` VARCHAR(15) NOT NULL DEFAULT '';
ALTER TABLE `0_consignor_branch` CHANGE `transport_discount_account` `transport_discount_account` VARCHAR(15) NOT NULL DEFAULT '';
ALTER TABLE `0_consignor_branch` CHANGE `receivables_account` `receivables_account` VARCHAR(15) NOT NULL DEFAULT '';
ALTER TABLE `0_consignor_branch` CHANGE `payment_discount_account` `payment_discount_account` VARCHAR(15) NOT NULL DEFAULT '';
...
ALTER TABLE `0_stock_category` CHANGE `dflt_transport_act` `dflt_transport_act` VARCHAR(15) NOT NULL DEFAULT '';
...
ALTER TABLE `0_stock_master` CHANGE `transport_account` `transport_account` VARCHAR(15) NOT NULL DEFAULT '';
...
ALTER TABLE `0_tax_types` CHANGE `transport_gl_code` `transport_gl_code` VARCHAR(15) NOT NULL DEFAULT '';
...
INSERT INTO `0_crm_persons` (`ref`, `email`, `lang`, `tmp_id`, `tmp_class`) 
	SELECT `consignor_ref`, `email`, if(`curr_code`=d.`lang`, NULL, 'en_GB'), `consignor_no`, 'consignor'
		FROM `0_consignors_master`,
...
INSERT INTO `0_crm_persons` (`ref`, `name`, `address`, `phone`, `phone2`,
	...
	SELECT `branch_ref`, `contact_name`, `br_address`, `phone`, `phone2`,
		`fax`,`email`,`branch_code`, 'consignor_branch' FROM `0_consignor_branch`;
...
ALTER TABLE `0_consignor_trans_details` ADD COLUMN `src_id` int(11) default NULL;
ALTER TABLE `0_consignor_trans_details` ADD KEY (`src_id`);
