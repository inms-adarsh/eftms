ALTER TABLE `0_company` DROP COLUMN `consignorom1_name`;
ALTER TABLE `0_company` DROP COLUMN `consignorom2_name`;
ALTER TABLE `0_company` DROP COLUMN `consignorom3_name`;
ALTER TABLE `0_company` DROP COLUMN `consignorom1_value`;
ALTER TABLE `0_company` DROP COLUMN `consignorom2_value`;
ALTER TABLE `0_company` DROP COLUMN `consignorom3_value`;
...
ALTER TABLE `0_stock_category` ADD COLUMN `dflt_transport_act` varchar(11) NOT NULL default '';
...
ALTER TABLE `0_consignors_master` MODIFY COLUMN `name` varchar(100) NOT NULL default '';

ALTER TABLE `0_consignor_branch` ADD COLUMN `inactive` tinyint(1) NOT NULL default '0';
...
ALTER TABLE `0_consignors_master` ADD COLUMN `consignor_ref` varchar(30) NOT NULL;
UPDATE `0_consignors_master` SET `consignor_ref`=`name` WHERE 1; 
ALTER TABLE `0_suppliers` ADD COLUMN `supp_ref` varchar(30) NOT NULL;
UPDATE `0_suppliers` SET `supp_ref`=`supp_name` WHERE 1; 
ALTER TABLE `0_consignor_branch` ADD COLUMN `branch_ref`	varchar(30) NOT NULL;
UPDATE `0_consignor_branch` SET `branch_ref`=`br_name` WHERE 1; 
...
ALTER TABLE `0_transport_order_details` ADD COLUMN `trans_type` SMALLINT(6) NOT NULL DEFAULT '30' AFTER `order_no`;
ALTER TABLE `0_transport_orders` CHANGE COLUMN `order_no` `order_no` int(11) NOT NULL;
ALTER TABLE `0_transport_orders` ADD COLUMN `trans_type` SMALLINT(6) NOT NULL DEFAULT '30' AFTER `order_no`;
ALTER TABLE `0_transport_orders` ADD COLUMN `reference` varchar(100) NOT NULL DEFAULT '' AFTER `branch_code`;
ALTER TABLE `0_transport_orders` DROP PRIMARY KEY;
ALTER TABLE `0_transport_orders` ADD PRIMARY KEY ( `trans_type` , `order_no` ); 
UPDATE `0_transport_orders`	SET `reference`=`order_no` WHERE 1;
...
ALTER TABLE `0_consignor_branch` ADD COLUMN `phone2` varchar(30) NOT NULL default '' AFTER `phone`;
...
ALTER TABLE `0_consignors_master` ADD COLUMN `notes` tinytext NULL default '' AFTER `credit_limit`;
ALTER TABLE `0_consignor_branch` ADD COLUMN `notes` tinytext NULL default '' AFTER `group_no`;
