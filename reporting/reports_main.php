...
$reports->addReportClass(_('Consignor'), RC_CONSIGNOR);
$reports->addReport(RC_CONSIGNOR, 101, _('Consignor &Balances'),
	array(	_('Start Date') => 'DATEBEGIN',
			_('End Date') => 'DATEENDM',
			_('Consignor') => 'CONSIGNORS_NO_FILTER',
...
$reports->addReport(RC_CONSIGNOR, 102, _('&Aged Consignor Analysis'),
	array(	_('End Date') => 'DATE',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_CONSIGNOR, 103, _('Consignor &Detail Listing'),
	array(	_('Activity Since') => 'DATEBEGIN',
			_('Transport Areas') => 'AREAS',
			_('Transport Folk') => 'TRANSPORTMEN',
			_('Activity Greater Than') => 'TEXT',
			_('Activity Less Than') => 'TEXT',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_CONSIGNOR, 114, _('Transport &Summary Report'),
	array(	_('Start Date') => 'DATEBEGINTAX',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_CONSIGNOR, 104, _('&Price Listing'),
	array(	_('Currency Filter') => 'CURRENCY',
			_('Inventory Category') => 'CATEGORIES',
			_('Transport Types') => 'TRANSPORTTYPES',
...
$reports->addReport(RC_CONSIGNOR, 105, _('&Order Status Listing'),
	array(	_('Start Date') => 'DATEBEGINM',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_CONSIGNOR, 106, _('&Transportman Listing'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Summary Only') => 'YES_NO',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_CONSIGNOR, 107, _('Print &Invoices'),
	array(	_('From') => 'INVOICE',
			_('To') => 'INVOICE',
			_('Currency Filter') => 'CURRENCY',
			_('email Consignors') => 'YES_NO',
			_('Payment Link') => 'PAYMENT_LINK',
			_('Comments') => 'TEXTBOX',
			_('Consignor') => 'CONSIGNORS_NO_FILTER',
			_('Orientation') => 'ORIENTATION'
));
$reports->addReport(RC_CONSIGNOR, 113, _('Print &Credit Notes'),
	array(	_('From') => 'CREDIT',
			_('To') => 'CREDIT',
			_('Currency Filter') => 'CURRENCY',
			_('email Consignors') => 'YES_NO',
			...
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION'));
$reports->addReport(RC_CONSIGNOR, 110, _('Print &Deliveries'),
	array(	_('From') => 'DELIVERY',
			...
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION'));
$reports->addReport(RC_CONSIGNOR, 108, _('Print &Statements'),
	array(	_('Consignor') => 'CONSIGNORS_NO_FILTER',
			_('Currency Filter') => 'CURRENCY',
			_('Show Also Allocated') => 'YES_NO',
			_('Email Consignors') => 'YES_NO',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION'));
$reports->addReport(RC_CONSIGNOR, 109, _('&Print Bilty'),
	array(	_('From') => 'ORDERS',
			_('To') => 'ORDERS',
			_('Currency Filter') => 'CURRENCY',
			_('Email Consignors') => 'YES_NO',
			...
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION'));
$reports->addReport(RC_CONSIGNOR, 111, _('&Print Loading Slips'),
	array(	_('From') => 'QUOTATIONS',
			...
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION'));
/*$reports->addReport(RC_CONSIGNOR, 112, _('Print Receipts'),
	array(	_('From') => 'RECEIPT',
			...
			_('Orientation') => 'ORIENTATION'));
*/
$reports->addReportClass(_('Vendor'), RC_SUPPLIER);
$reports->addReport(RC_SUPPLIER, 201, _('Vendor &Balances'),
	array(	_('Start Date') => 'DATEBEGIN',
			_('End Date') => 'DATEENDM',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_SUPPLIER, 202, _('&Aged Vendor Analyses'),
	array(	_('End Date') => 'DATE',
			_('Vendor') => 'SUPPLIERS_NO_FILTER',
			_('Currency Filter') => 'CURRENCY',
			_('Show Also Allocated') => 'YES_NO',
...
$reports->addReport(RC_SUPPLIER, 204, _('Outstanding &GRNs Report'),
	array(	_('Vendor') => 'SUPPLIERS_NO_FILTER',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_SUPPLIER, 205, _('Vendor &Detail Listing'),
	array(	_('Activity Since') => 'DATEBEGIN',
			_('Activity Greater Than') => 'TEXT',
			_('Activity Less Than') => 'TEXT',
			_('Comments') => 'TEXTBOX',
...
$reports->addReport(RC_INVENTORY, 303, _('Stock &Check Sheets'),
	array(	_('Inventory Category') => 'CATEGORIES',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 304, _('Inventory &Transport Report'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Inventory Category') => 'CATEGORIES',
			_('Location') => 'LOCATIONS',
...
$reports->addReport(RC_INVENTORY, 308, _('C&osted Inventory Movement Report'),
	array(	_('Start Date') => 'DATEBEGINM',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));				
$reports->addReport(RC_INVENTORY, 309,_('Item &Transport Summary Report'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Inventory Category') => 'CATEGORIES',
			_('Comments') => 'TEXTBOX',
...
$reports->addReportClass(_('Maintainence'), RC_MANUFACTURE);
...
add_consignorom_reports($reports);
