...
// 	* supports consignorom page formats, margins and units of measure;
 ...
 * <li>supports consignorom page formats, margins and units of measure;</li>
	...
	*/
	class TCPDF {
		...
		*/
		 ...
		 * @param mixed $format The format used for pages. It can be either one of the following values (case insensitive) or a consignorom format in the form of a two-element array containing the width and the height (expressed in the unit given by unit).<ul><li>4A0</li><li>2A0</li><li>A0</li><li>A1</li><li>A2</li><li>A3</li><li>A4 (default)</li><li>A5</li><li>A6</li><li>A7</li><li>A8</li><li>A9</li><li>A10</li><li>B0</li><li>B1</li><li>B2</li><li>B3</li><li>B4</li><li>B5</li><li>B6</li><li>B7</li><li>B8</li><li>B9</li><li>B10</li><li>C0</li><li>C1</li><li>C2</li><li>C3</li><li>C4</li><li>C5</li><li>C6</li><li>C7</li><li>C8</li><li>C9</li><li>C10</li><li>RA0</li><li>RA1</li><li>RA2</li><li>RA3</li><li>RA4</li><li>SRA0</li><li>SRA1</li><li>SRA2</li><li>SRA3</li><li>SRA4</li><li>LETTER</li><li>LEGAL</li><li>EXECUTIVE</li><li>FOLIO</li></ul>
		...
		*/
		...
		/**
		* This method is automatically called in case of fatal error; it simply outputs the message and halts the execution. An inherited class may override it to consignoromize the error handling but should always halt the script, or the resulting document would probably be invalid.
		...
		function ImageEps($file, $x, $y, $w=0, $h=0, $link='', $useBoundingBox=true, $align='', $palign='') {
			...
			for ($i=0; $i < $cnt; $i++) {
				...
				switch ($cmd) {
					...
					case 'x': {// consignorom fill color
						list($c,$m,$y,$k) = $chunks;
						$this->_out("$c $m $y $k k");
						break;
					}
					case 'X': { // consignorom stroke color
						list($c,$m,$y,$k) = $chunks;
						$this->_out("$c $m $y $k K");
						break;
					}
