...
function print_aged_supplier_analysis()
{
	...
	$headers = array(_('Vendor'),	'',	'',	_('Current'), $nowdue, $pastdue1,$pastdue2,
		_('Total Balance'));
	...
	$aligns = array('left',	'left',	'left',	'right', 'right', 'right', 'right',	'right');
    	...
    	$params =   array( 	0 => $comments,
    				...
    				2 => array('text' => _('Vendor'), 'from' => $from, 'to' => ''),
    ...
    $rep = new FrontReport(_('Aged Vendor Analysis'), "AgedVendorAnalysis", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
