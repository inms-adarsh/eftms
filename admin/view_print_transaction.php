...
function prt_link($row)
{
	if (!isset($row['type']))
  	...
  	if ($row['type'] == ST_PURCHORDER || $row['type'] == ST_TRANSPORTORDER || $row['type'] == ST_TRANSPORTQUOTE || $row['type'] == ST_TRANSPORTBOOKING || 
...
function handle_search()
{
	if (check_valid_entries()==true)
	{
		...
		$print_out = ($print_type == ST_TRANSPORTINVOICE || $print_type == ST_CONSIGNORCREDIT || $print_type == ST_CONSIGNORDELIVERY ||
			$print_type == ST_PURCHORDER || $print_type == ST_TRANSPORTORDER || $print_type == ST_TRANSPORTQUOTE || $print_type == ST_TRANSPORTBOOKING || 
			$print_type == ST_CONSIGNORPAYMENT || $print_type == ST_SUPPAYMENT || $print_type == ST_WORKORDER);
