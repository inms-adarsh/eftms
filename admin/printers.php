...
text_row_ex(_("Printer Name").':', 'name', null, 20, 20);
text_row_ex(_("Printer Description").':', 'descr', null, 40, 60);
text_row_ex(_("Host name or IP").':', 'host', null, 30, 40);
text_row_ex(_("Port").':', 'port', null, 5, 5);
text_row_ex(_("Printer Queue").':', 'queue', null, 20, 20);
text_row_ex(_("Timeout").':', 'tout', null, 5, 5);
