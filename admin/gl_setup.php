...
if (isset($_POST['submit']) && can_process())
{
	update_company_prefs( get_post( array( 'retained_earnings_act', 'profit_loss_year_act',
		'consignors_act', 'pyt_discount_act', 'creditors_act', 'freight_act',
		'exchange_diff_act', 'bank_charge_act', 'default_transport_act', 'default_transport_discount_act',
		'default_prompt_payment_act', 'default_inventory_act', 'default_cogs_act',
		'default_adj_act', 'default_inv_transport_act', 'default_assembly_act', 'legal_text',
...
$_POST['consignors_act']  = $myrow["consignors_act"];
...
$_POST['default_transport_act'] = $myrow["default_transport_act"];
$_POST['default_transport_discount_act']  = $myrow["default_transport_discount_act"];
...
$_POST['default_inv_transport_act'] = $myrow['default_inv_transport_act'];
...
form_section_title(_("General GL"));
...
form_section_title(_("Consignors and Transport"));
...
form_section_title(_("Consignors and Transport Defaults"));
// default for consignor branch
gl_all_accounts_list_row(_("Receivable Account:"), 'consignors_act');

gl_all_accounts_list_row(_("Transport Account:"), 'default_transport_act', null,
	false, false, true);

gl_all_accounts_list_row(_("Transport Discount Account:"), 'default_transport_discount_act');
...
form_section_title(_("Inventory"));

check_row(_("Allow Negative Inventory:"), 'allow_negative_stock', null);
label_row(null, _("Warning:  This may cause a delay in GL postings"), "", "class='stockmankofg' colspan=2"); 
*/
form_section_title(_("Items Defaults"));
gl_all_accounts_list_row(_("Transport Account:"), 'default_inv_transport_act', $_POST['default_inv_transport_act']);
...
//----------------
/*
form_section_title(_("Manufacturing Defaults"));
