...
function compress_list_row($label, $name, $value=null)
{
	...
	echo "<div class='form-group'><label class='control-label col-md-3'>$label</label><div class='col-md-6'>";
...
start_form(true, true);
    ...
    end_form_section();
	echo "<div class='form-group'><label class='col-md-3'></label><div class='col-md-3'>".get_backup_file_combo()."></div><div class='col-md-3' style='margin-left:15px'>";
    ...
    submit_row('upload',_("Upload file"),"style='padding-left:20px'", '', true);
    echo "</div></div>";
