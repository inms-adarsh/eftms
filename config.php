...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	/* Do not print zero lines amount of 0.00 in Transport Documents if service item. 1 = do not */
...
/*	
	Before upgrade from pre-2.2 FA you have to move here your consignoromized
...
/*
	Optional sorting transport documents lines during edition according to item code
*/
$sort_transport_items = false;
