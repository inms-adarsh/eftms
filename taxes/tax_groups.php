...
function can_delete($selected_id)
{
	if ($selected_id == -1)
		return false;
	if (key_in_foreign_table($selected_id, 'consignor_branch', 'tax_group_id'))	
	{
		display_error(_("Cannot delete this tax group because consignor branches been created referring to it."));
		return false;
	}
...
{
	check_table_row($item['tax_type_name'], 'tax_type_id' . $item['tax_type_id'], 
