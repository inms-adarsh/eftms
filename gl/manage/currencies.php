...
function check_can_delete($curr)
{
	...
	if (key_in_foreign_table($curr, 'consignors_master', 'curr_code'))
	{
		display_error(_("Cannot delete this currency, because consignor accounts have been created referring to this currency."));
		return false;
	}
...
function handle_delete()
{
	...
	//only delete if used in neither consignor or supplier, comp prefs, bank trans accounts
