...
//include_once($path_to_root . "/transport/includes/ui/consignor_alloc_ui.inc");
...
page(_($help_context = "Allocate Consignor Payment or Credit Note"), false, false, "", $js);
...
{
	clear_allocations();
	meta_forward($path_to_root . "/transport/allocations/consignor_allocation_main.php");
}
...
{
	clear_allocations();
	$_SESSION['alloc'] = new allocation($_GET['trans_type'], $_GET['trans_no'], @$_GET['consignor_no'], PT_CONSIGNOR);
}
