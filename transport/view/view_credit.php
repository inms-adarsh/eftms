...
$myrow = get_consignor_trans($trans_id, ST_CONSIGNORCREDIT);
...
end_row();
comments_display_row(ST_CONSIGNORCREDIT, $trans_id);
end_table();
...
$result = get_consignor_trans_details(ST_CONSIGNORCREDIT, $trans_id);
...
$tax_items = get_trans_tax_details(ST_CONSIGNORCREDIT, $trans_id);
...
$voided = is_voided_display(ST_CONSIGNORCREDIT, $trans_id, _("This credit note has been voided."));

if (!$voided)
	display_allocations_from(PT_CONSIGNOR,
		$myrow['consignor_no'], ST_CONSIGNORCREDIT, $trans_id, $credit_total);

/* end of check to see that there was an invoice record to print */

end_page(true, false, false, ST_CONSIGNORCREDIT, $trans_id);
