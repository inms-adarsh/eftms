...
//---------------------------------------------------------------------------
//
//	Entry/Modify Credit Note for selected Transport Invoice
//

$page_security = 'SA_TRANSPORTCREDITINV';
$path_to_root = "..";
...
if (isset($_GET['AddedID'])) {
	...
	display_note(get_consignor_trans_view_str($trans_type, $credit_no, _("&View This Credit Note")), 0, 0);
...
if (isset($_GET['InvoiceNumber']) && $_GET['InvoiceNumber'] > 0) {
    ...
    $_SESSION['Items'] = new Cart(ST_TRANSPORTINVOICE, $_GET['InvoiceNumber'], true);
	copy_from_cart();

} elseif ( isset($_GET['ModifyCredit']) && $_GET['ModifyCredit']>0) {

	$_SESSION['Items'] = new Cart(ST_CONSIGNORCREDIT, $_GET['ModifyCredit']);
	copy_from_cart();
...
//		$_POST['ref'] = $Refs->get_next(11);
    ...
    label_cells(_("Crediting Invoice"), get_consignor_trans_view_str(ST_TRANSPORTINVOICE, array_keys($_SESSION['Items']->src_docs)), "class='tableheader2'");
...
//	  $_POST['transport_type_id'] = $_SESSION['Items']->transport_type;
//	label_cell(_("Transport Type"), "class='tableheader2'");
//	transport_types_list_cells(null, 'transport_type_id', $_POST['transport_type_id']);
