...
check_db_has_vehicles(_("There are vehicles defined in the system."));
...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM')
{
	...
	if ($input_error == 0)
	{
	 ...
	 $_POST['date_of_reading'], $_POST['driver_id'], $_POST['log_description'],$_POST['odometer_id']);
...
if (!@$_GET['popup'])
{
	...
	//echo vehicle_list_row(_("Vehicle:"), 'vehicle_id', $_POST['vehicle_id'],false,true);
	//echo vehicle_list_row(_("Vehicle:"), 'vehicle_id', $_POST['vehicle_id'], true, false, false, true);
