...
include($path_to_root . "/transport/includes/db/credit_status_db.inc");
...
{
	if (key_in_foreign_table($selected_id, 'consignors_master', 'credit_status'))
	{
		display_error(_("Cannot delete this credit status because consignor accounts have been created referring to it."));
		return false;
	}
