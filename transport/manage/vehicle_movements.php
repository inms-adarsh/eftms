...
page(_($help_context = "Vehicle Location Transfers"), false, false, "", $js);
...
if (isset($_GET['AddedID'])) 
{
	...
	display_notification_centered(_("Vehicle transfer has been processed"));
...
if (isset($_POST['Process']))
{
	...
	else 
	{
		...
		if ($failed_item >= 0) 
		{
        	...
        	display_error(_("The quantity entered is greater than the available quantity for this vehicle at the source location :") .
