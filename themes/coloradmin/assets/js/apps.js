...
var handleThemePageStructureControl = function() {
    ...
    if ($.cookie && $.cookie('theme')) {
        ...
        var cssFileSrc = theme+'/themes/coloradmin/assets/css/theme/' + $.cookie('theme') + '.css';
    ...
    $('.theme-list [data-theme]').live('click', function() {
        var cssFileSrc = theme+'/themes/coloradmin/assets/css/theme/' + $(this).attr('data-theme') + '.css';
        $('#theme').attr('href', cssFileSrc);
