...
page(_($help_context = "View Vendor Credit Note"), true, false, "", $js);
...
start_row();
label_cells(_("Vendor"), $supp_trans->supplier_name, "class='tableheader2'");
label_cells(_("Reference"), $supp_trans->reference, "class='tableheader2'");
label_cells(_("Vendor's Reference"), $supp_trans->supp_reference, "class='tableheader2'");
end_row();
start_row();
