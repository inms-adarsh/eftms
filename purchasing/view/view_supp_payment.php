...
page(_($help_context = "View Payment to Vendor"), true, false, "", $js);
...
display_heading(_("Payment to Vendor") . " #$trans_no");

echo "<br>";
start_table(TABLESTYLE2, "width=80%");

start_row();
label_cells(_("To Vendor"), $receipt['supplier_name'], "class='tableheader2'");
...
if ($show_currencies) 
{
	label_cells(_("Vendor's Currency"), $receipt['curr_code'], "class='tableheader2'");
}
