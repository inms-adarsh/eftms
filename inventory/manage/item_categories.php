	...
	if ($input_error !=1)
	{
    	if ($selected_id != -1) 
    	{
		    update_item_category($selected_id, $_POST['description'],
				$_POST['tax_type_id'],	$_POST['transport_account'], 
...
$th = array(_("Name"), _("Tax type"), _("Units"), _("Type"), _("Transport Act"),
...
while ($myrow = db_fetch($result)) 
{
	...
	label_cell($myrow["dflt_transport_act"], "align=center");
...
if ($selected_id != -1) 
{
 	if ($Mode == 'Edit') {
		...
		$_POST['transport_account']  = $myrow["dflt_transport_act"];
	...
	if (get_post('transport_account') == "")
		$_POST['transport_account'] = $company_record["default_inv_transport_act"];
