...
if (!@$_GET['popup'])
{
	if (isset($_GET['stock_id'])){
		page(_($help_context = "Vehicle Location Status"), true);
	} else {
		page(_($help_context = "Vehicle Location Status"));
	}
}
if (isset($_GET['stock_id']))
...
{
	display_note(_("This is a service and cannot have a stock holding, only the total quantity on outstanding transport orders is shown."), 0, 1);
...
{
	$th = array(_("Location"), _("Available"));
}
table_header($th);
