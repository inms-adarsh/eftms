...
$selected_component = $selected_id2;
//--------------------------------------------------------------------------------------------------
...
{ //Parent Item selected so display bom or edit component
	...
	if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM')
		on_submit($selected_parent, $selected_id2);
	//--------------------------------------------------------------------------------------
...
start_form();
	...
	if ($selected_id2 != -1)
	{
 		if ($Mode == 'Edit') {
			...
			$myrow = get_component_from_bom($selected_id2);
	...
	end_table(1);
	submit_add_or_update_center($selected_id2 == -1, '', 'both');
	end_form();
}
// ----------------------------------------------------------------------------------
